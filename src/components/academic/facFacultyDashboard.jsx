                ...
                <div className="left-column">
                  ...
                  <div className="content-box">
                    ...
                    <div className="quick-actions-grid">
                      ...
                      <button className="action-btn" onClick={() => setShowNoticeModal(true)}>
                        <span className="action-icon">📢</span>
            ...
            <div className="dashboard-tab-container">
              <div className="tab-page-header">
                <div>
                  ...
                  <p>Manage course alerts, ERP synchronization, and office hours</p>
                </div>
              </div>
              ...
              <div className="content-box">
                <div className="settings-section">
                  ...
                  <div className="settings-item">
                    <div>
                      <strong>Doubt Query Notification</strong>
                      <p>Receive email notification when a student submits an AI/ML question</p>
                    </div>
                    <input type="checkbox" defaultChecked className="toggle-switch" />
                  </div>
                  ...
                  <div className="settings-item">
                    <div>
                      ...
                      <p>Enable dark mode theme for the portal interface</p>
                    </div>
