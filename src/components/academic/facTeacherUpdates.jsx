...
//     date: "16 Aug 2026",
//     time: "10:30 AM",
//     summary: "Invigilation duty roster for Semester 6 (Spring 2026) has been allocated. Dr. Yogender Sharma is assigned 4 Theory Sessions in Block 3 and 2 Lab Audits.",
//     content: "All assigned faculty members are requested to report 30 minutes prior to exam commencement at the Control Room. In case of any official clash, submit swap requisition by 18 Aug.",
...
//     date: "14 Aug 2026",
//     time: "02:15 PM",
//     summary: "Sanction letter received from Science and Engineering Research Board (SERB) for project 'Real-time Autonomous Edge Vision Systems'. Initial grant release of ₹24.5 Lakhs initiated.",
//     content: "Principal Investigator Dr. Yogender Sharma and Co-PIs are requested to attend the grant procurement briefing this Thursday at 11:00 AM in the Research Annex.",
...
//     date: "12 Aug 2026",
//     time: "04:00 PM",
//     summary: "Review meeting for Course Outcome (CO) - Program Outcome (PO) mapping matrices for CS-301 and lab assessment rubrics.",
//     content: "Venue: Department Conference Room (Block 3, 4th Floor). Please bring finalized internal assessment logs and student course feedback folders.",
...
//     date: "10 Aug 2026",
//     time: "11:45 AM",
//     summary: "All course instructors must sync weekly student attendance sheets to the central server before every Friday 05:00 PM.",
//     content: "Bi-weekly shortage notices will be generated automatically for students below 75% attendance based on ERP logs.",
//     attachment: null,
//     read: true,
//   },
//   {
...
//     date: "08 Aug 2026",
//     time: "09:15 AM",
//     summary: "Call for Papers & Technical Committee Session Chair nominations open. University faculty entitled to 100% registration fee reimbursement.",
//     content: "Accepted papers will be indexed in IEEE Xplore. Faculty members can submit full research drafts via the conference CMT portal.",
...
//               onClick={onBack}
//               style={{ marginBottom: "0.6rem", display: "inline-flex", alignItems: "center", gap: "5px" }}
//             >
//               ← Back to Dashboard
//             </button>
//           )}
//           <h2>📢 Teacher Updates & Official Notices</h2>
//           <p>Official circulars, exam duty allocations, meeting notices, and research updates for Dr. Yogender Sharma</p>
//         </div>
//         <div className="updates-header-stats">
//           {unreadCount > 0 && (
//             <span className="unread-count-pill">🔔 {unreadCount} New Notices</span>
//           )}
//           <span className="pill">Total: {updates.length} Notices</span>
//         </div>
//       </div>
...
//           {["All", "Urgent", "Academic", "Research", "Exam Cell", "Administrative"].map(
//             (cat) => (
//               <button
//                 key={cat}
//                 type="button"
...
//           <div
//             key={notice.id}
//             className={`notice-card ${!notice.read ? "unread" : ""} ${
...
//               <p>{notice.summary}</p>
//               {notice.content && (
//                 <p style={{ marginTop: "0.4rem", color: "#64748b", fontStyle: "italic" }}>
//                   ℹ️ {notice.content}
//                 </p>
//               )}
//             </div>
...
//                 >
//                   {notice.read ? "Mark Unread" : "✓ Mark as Read"}
//                 </button>
//               </div>
//             </div>
//           </div>
...
//       <div className="widget-items-list" style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
//         {updates.map((item) => (
//           <div
//             key={item.id}
//             className={`widget-notice-item ${!item.read ? "unread-item" : ""}`}
//             onClick={onOpenAll}
//           >
//             <span className="widget-item-icon">{item.icon}</span>
//             <div className="widget-item-content">
//               <strong>{item.title}</strong>
//               <p>{item.senderDept} • {item.summary.slice(0, 75)}...</p>
//               <div className="widget-item-meta">
//                 <span
//                   style={{
//                     color: item.priority === "Urgent" ? "#dc2626" : "#2563eb",
//                     fontWeight: "700",
//                   }}
//                 >
//                   {item.priority}
      ...
      <div className="updates-page-header">
        <div>
          ...
          <p>
            ...
            research updates for Dr. Yogender Sharma
          </p>
        </div>
